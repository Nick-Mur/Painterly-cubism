...
def house_level():
    ...
    trx2, try2 = 750, 300
    trx3, try3 = 425, 0
    # начальные координаты крыши дома
    # начальные координаты ручки двери дома
    x_old, y_old, x_new, y_new = 0, 0, 0, 0
    x_old1, y_old1, x_new1, y_new1 = 0, 0, 0, 0
    x_old2, y_old2, x_new2, y_new2 = 0, 0, 0, 0
    run = True
    while run:
...
def levels():
    ...
    if c > 0:
        if language_now == 'Eng':
            ...
            menu.add.button('The boat', soon, font_size=70)
            ...
            menu.add.button('Кораблик', soon, font_size=70)
